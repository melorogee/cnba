        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">人才招聘</div>
								...
								for (var i = 0; i < ret.length; i++) {
									//alert(ret[i]["sqlcontent"]);
									 ...
									 var date = ret[i]["date"];
										...
										html += "<li><span class='glyphicon glyphicon-forward'></span>&nbsp;<a href='"+url+"'>"+title+"</a><span class='pull-right'><small>"+date+"</small></span></li>";
								}
