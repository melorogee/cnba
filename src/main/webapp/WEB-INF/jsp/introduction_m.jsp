...
<script type="text/javascript">
		...
		var component = {
							...
							if (ret.length > 0) {
								...
								for (var i = 0; i < ret.length; i++) {
									//alert(ret[i]["sqlcontent"]);
									 html = ret[i]["content"].replace(/img src="/g,"img src=\"http://47.101.219.55")
								}
								editor1.sync(); 
			...
			save : function() {
				...
				$.ajax({
					url : '/sunflower/metadata/save_companyIntroduction.do',
					type : 'POST',
					data : {
						'content' : content
					},
					...
					success : function(ret) {
							alert("保存成功");
							window.location.href="/sunflower/metadata/introduction_m.do";
							}
				});
			}
