        ...
        <div class="row">
            <div class="col-md-3">
                <div class="panel panel-primary">
                    <div class="panel-heading">品牌建设</div>
                    <div class="panel-body">
                        <ul class="list-unstyled links">
                            <li><span class="glyphicon glyphicon-forward blue"></span>&nbsp;<a href="brandbuild.do">品牌建设</a></li>
                            <li><span class="glyphicon glyphicon-forward blue"></span>&nbsp;<a href="trainning.do">培训体系</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">公司培训体系</div>
    ...
    <script type="text/javascript">
		...
		var component = {
			...
			companyIntroduction : function() {
				$.ajax({
					url : '/sunflower/metadata/gettraining.do',
					type : 'POST',
