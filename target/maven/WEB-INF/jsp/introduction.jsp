                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <ul class="list-unstyled links">
                            <li><span class="glyphicon glyphicon-forward blue"></span>&nbsp;<a href="introduction.do">公司介绍</a></li>
                            <li><span class="glyphicon glyphicon-forward blue"></span>&nbsp;<a href="culture.do">公司文化</a></li>
                            <li><span class="glyphicon glyphicon-forward blue"></span>&nbsp;<a href="file.do">公司档案</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
		...
		var component = {
			...
			companyIntroduction : function() {
				$.ajax({
					url : '/sunflower/metadata/companyIntroduction.do',
					type : 'POST',
