...
(/** @lends <global> */function( $ ) {
	...
	{
		if(sessionStorage.StoragePage!=undefined){
			if(sessionStorage.dataTablePage!=sessionStorage.StoragePage){
				sessionStorage.dataTablePage=sessionStorage.StoragePage;
				sessionStorage.removeItem("iDisplayStart");
			}
			if(sessionStorage.iDisplayStart!=undefined){
				settings._iDisplayStart = parseInt(sessionStorage.iDisplayStart);
			}	
		}
		...
		//处理自定义属性
		for(var item in settings.defData){
			data.push( { 'name': item, 'value': $("#"+settings.defData[item]).val() } );
	...
	function _fnInitComplete ( settings, json )
	{
		...
		if(sessionStorage.iDisplayStart!=undefined){
				...
				var dt_index = (sessionStorage.iDisplayStart/settings._iDisplayLength)+1;
				$(".pagination li a").each(function(){
					if($(this).text()==dt_index){
	...
	function _fnPageChange ( settings, action, redraw )
	{
		...
		sessionStorage.iDisplayStart=start;
		return changed;
	}
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			oSettings.defData = options.defData;
	...
	$.fn.dataTableExt.oPagination.input = {
		'fnInit': function (oSettings, nPaging, fnCallbackDraw) {
			...
			$(nInput).keyup(function (e) {
				...
				sessionStorage.iDisplayStart=iNewStart;
